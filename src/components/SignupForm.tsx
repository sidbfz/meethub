...
import { createDemoAuthUser, DEMO_MODE, persistDemoSession } from "@/lib/demo-mode";
...
export default function SignupForm() {
  ...
  const onSubmit = async (data: SignupFormData) => {
    try {
      ...
      if (DEMO_MODE) {
        const demoUser = createDemoAuthUser(data.email, data.name);
        persistDemoSession(demoUser);
        setSuccessMessage(`Welcome ${data.name}! Demo account created successfully.`);
        reset();
        router.push("/");
        return;
      }
